...
# OpenCode: use the staged host binary prepared by scripts/prepare_three_regression.py
COPY _tmp/three-regression/shared-home/.opencode/bin/opencode /usr/local/bin/opencode
